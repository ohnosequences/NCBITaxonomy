...
case object titan {
  ...
  implicit final class ncbiTitanGraph(val graph: TitanNCBITaxonomyGraph)
      extends AnyVal
      with TaxonomyGraph[TitanNode] {
  ...
  implicit final class ncbiTitanTaxon(val node: TitanNode)
      extends AnyVal
      with Taxon[TitanNode] {
